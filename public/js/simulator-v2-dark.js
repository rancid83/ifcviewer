...
class SimulationDataManager {
    ...
    async loadMetadata(caseName, season) {
        ...
        try {
            const response = await fetch(`/data/simulation2/${dataPath}/index.json`);
    ...
    async loadChunk(chunkIndex, skipCache = false) {
        ...
        try {
            const response = await fetch(`/data/simulation2/${dataPath}/chunk-${chunkIndex}.json`);
